  ...
  return (
    <div className="text-white md:p-20 p-14">
      ...
      <div className={mono.className}>
        <section>
          <h2 className="text-xl md:text-lg mt-4 text-fuchsia-300 font-bold drop-shadow-lg shadow-black">
            Languages:
          </h2>
        ...
        <section>
          <h2 className="text-xl md:text-lg mt-8 text-fuchsia-300 font-bold drop-shadow-lg shadow-black">
            Frameworks & Tools:
          </h2>
          <ul className="text-base md:text-lg mt-4 space-y-2">
